...
<header class="header"   style="background-color:#0b243b">
        <div class="header__top">
            <div class="container">
                <div class="row">
                    ...
                    ?>
                            ...
                            <div class="choose-login" style="background-color:white; ">
                <a href="trangdangxuat.php" style="color:black; ">𝕃𝕆𝔾 𝕆𝕌𝕋</a>
            </div>
            ...
            <div class="choose-registration" style="background-color:white">
                            ...
                            <div class="header__logo" >
                                <a href="./index.php"><img src="img/blog/a11.jpg" alt=""  ></a>
                            </div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                ...
                                <a href="#" class="primary-btn" style="background:#0b243b">Our Books</a>
                            </div>
                        </div>
                    </div>
                </div>
...
//                ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="class__form">
                        <div class="section-title">
                            <span style="color:#0b243b"> North Hills</span>
    ...
    <div class="map">
        ...
        <div class="map__iframe">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d287411.1627546774!2d37.5975786!3d55.7515584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46b54a4d1ce4cf1b%3A0xd4d3694e66cb2dc6!2sWar%20Thunder!5e0!3m2!1svi!2s!4v1714812265578!5m2!1svi!2s" height="300" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
    </div>
    <!-- Map End -->
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <p class="copyright__text text-white"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                          Copyright &copy;<script>document.write(new Date().getFullYear());</script> Thực tập chuyên ngành || Nhóm 15</a>
